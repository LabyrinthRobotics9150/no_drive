...
public class FollowClosestAprilTagCommand extends Command {
    ...
    // Constants
    private static final double TARGET_DISTANCE = 1.0; // meters (desired distance from the AprilTag)
    ...
    public void execute() {
        ...
        double forwardSpeed = -distanceController.calculate(distance, TARGET_DISTANCE); // Maintain target distance
